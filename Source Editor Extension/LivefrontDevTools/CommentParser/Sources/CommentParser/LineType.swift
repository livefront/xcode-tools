...
enum LineType: Equatable {
    ...
    /// the description of a parameter or return block.
    ///
    /// - Parameters:
    ...
    /// A line which signals the start of a return description block.
    ///
    /// - Parameters:
    ///   - tokens: The whitespace-separated parts of the text.
    ///   - targeted: `true` iff this line was contained in a selection range.
    ///   - text: The original unmodified line of text.
    ///
    case headerCommentReturnStart(tokens: [String], targeted: Bool, text: String)
